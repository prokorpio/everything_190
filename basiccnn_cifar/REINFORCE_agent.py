...
class REINFORCE_agent():
    ...
    def get_action(self, state):
        ...
        action_prob_distrib = self.policy(state)
        m = Normal(action_prob_distrib, torch.tensor([1.0]))
        action = m.rsample()
        action_log_prob = m.log_prob(action)
    ...
    def update_policy(self, episode_rewards, actions, action_log_prob):
        ...
        objective_func = episode_rewards[0]
